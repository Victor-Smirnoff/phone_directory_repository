...
2. Выбрать операцию для выполнения, их предусмотрено 4: 1 - вывод записей на экран, 2 - добавление новой записи, 3 - редактирование записи, 4 - поиск записи.
...
В самом первом меню введите цифру 2.
